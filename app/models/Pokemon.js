export class Pokemon {
    ...
    get MyPokemonsHTMLTemplate() {
        return `
        <p onclick="app.PokemonController._drawMyPokemon(pokemonIndex)" class="clickable" type="button"><i class="mdi mdi-pokeball"></i>${this.name}</p>
        `
    }
    get PokemonHTMLTemplate() {
        return `
            <div class="row">
                <div class="col-12 d-flex align-items-center justify-content-center bg-danger border border-4 border-black m-0 p-0">
                    <div class=" mx-5 p-2">
                        <h2 class="bg-white mx-5 p-2">${this.name}</h2>
                    </div>
                </div>
                <div class="col-12">
                    <img src="${this.imgUrl}" alt="Pokemon Picture">
                </div>
                <div class="col-12 card fw-bold m-0 p-3">
                    <div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button class="btn bg-white text-danger border border-2 border-danger"><i class="mdi mdi-pokeball"></i>Catch</button>
                    </div>
                </div>
            </div>
        `
